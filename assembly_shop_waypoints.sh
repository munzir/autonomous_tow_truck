...
# Define the CSV file path (only change this line to switch routes)
CSV_FILE="/root/autonomous_tow_truck/src/waypoint_publisher/waypoint_publisher/waypoints_to_AS.csv"
