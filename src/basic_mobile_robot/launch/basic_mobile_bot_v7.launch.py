...
#     )
  ...
  ld.add_action(start_ros2_navigation_cmd) #amcl off, using the nav2 bringup - modified  (add in end)
  #ld.add_action(start_ros2_navigation_cmd_amcl) #amcl on, using the nav2 available directory (add in end)
