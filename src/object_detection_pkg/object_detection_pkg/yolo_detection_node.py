...
class YoloDetectionNode(Node):
    def __init__(self):
        ...
        self.model = torch.hub.load('/home/hp/autonomous_tow_truck/src/object_detection_pkg/object_detection_pkg/yolov5', 
                            'custom', path='/home/hp/yolov5n.pt', source='local')
