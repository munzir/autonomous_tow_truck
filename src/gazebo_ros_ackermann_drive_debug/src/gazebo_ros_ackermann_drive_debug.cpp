...
#include <gazebo_plugins/gazebo_ros_ackermann_drive_debug.hpp>
...
void GazeboRosAckermannDrive::Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  RCLCPP_WARN(impl_->ros_node_->get_logger(), "Hello This is Munzir!\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "0\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "1\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "2\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "3\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "4\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "5\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "6\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "7\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "7.1\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "9\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "10\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "11\n");
  ...
  if(debug) RCLCPP_WARN(impl_->ros_node_->get_logger(), "12\n");
...
void GazeboRosAckermannDrivePrivate::OnUpdate(const gazebo::common::UpdateInfo & _info)
{
  ...
  if(debug) RCLCPP_WARN(ros_node_->get_logger(), 
		  ...
		  "target_right_steering=%f, right_steering_angle=%f, "
		  "right_steering_diff=%f, right_steering_cmd=%f", 
		  target_rot, wheel_separation_, tanSteer, target_right_steering, 
		  right_steering_angle, right_steering_diff, right_steering_cmd);
